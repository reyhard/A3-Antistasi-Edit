...
["vehicleLightUnarmed", "rhsgref_ins_uaz"] call _fnc_saveToTemplate; 		//this line determines light and unarmed vehicles. -- Example: ["vehiclesLightUnarmed", ["B_MRAP_01_F"]] -- Array, can contain multiple assets
...
["vehicleTruck", "rhsgref_ins_ural_open"] call _fnc_saveToTemplate; 			//this line determines the trucks -- Example: ["vehiclesTrucks", ["B_Truck_01_transport_F","B_Truck_01_covered_F"]] -- Array, can contain multiple assets
...
["vehicleAA", "rhsgref_ins_ural_Zu23"] call _fnc_saveToTemplate; 		//this line determines cargo trucks -- Example: ["vehiclesCargoTrucks", ["B_Truck_01_transport_F","B_Truck_01_covered_F"]] -- Array, can contain multiple assets
...
["vehicleRepair", "rhsgref_ins_ural_repair"] call _fnc_saveToTemplate; 			//this line determines gun boats -- Example: ["vehiclesGunboats", ["B_Boat_Armed_01_minigun_F"]] -- Array, can contain multiple assets
...
["staticAT", "rhsgref_ins_SPG9M"] call _fnc_saveToTemplate; 					//this line determinesstatic ATs -- Example: ["staticAT", ["B_static_AT_F"]] -- Array, can contain multiple assets
["staticAA", "rhsgref_ins_ZU23"] call _fnc_saveToTemplate; 					//this line determines static AAs -- Example: ["staticAA", ["B_static_AA_F"]] -- Array, can contain multiple assets
["staticMortar", "rhsgref_ins_2b14"] call _fnc_saveToTemplate; 				//this line determines static mortars -- Example: ["staticMortar", ["B_Mortar_01_F"]] -- Array, can contain multiple assets
...
"rhsgref_uniform_3color_desert","rhsgref_uniform_TLA_1","rhsgref_uniform_TLA_2","rhs_insurgent_uniform_1",
"rhs_insurgent_uniform_2","rhs_insurgent_uniform_3","rhs_insurgent_uniform_4","rhs_insurgent_uniform_5","rhs_uniform_klmk_oversuit","rhs_uniform_gorka_r_y"];

private _initialRebelEquipment = [
"rhs_weap_type94_new","rhs_weap_tt33","rhs_weap_kar98k","rhs_weap_MP44","rhs_weap_m1garand_sa43"
"rhs_weap_rpg75",
"rhs_mag_6x8mm_mhp","rhs_mag_762x25_8","rhsgref_5Rnd_792x57_kar98k","rhsgref_8Rnd_762x63_Tracer_M1T_M1rifle","rhsgref_30Rnd_792x33_SmE_StG","rhs_grenade_mkii_mag","rhs_grenade_mki_mag","rhs_mag_rdg2_black","rhs_grenade_m15_mag",
"B_FieldPack_blk","B_FieldPack_cbr","B_FieldPack_green_F","B_FieldPack_khk","B_FieldPack_oli","B_Messenger_Gray_F","B_Messenger_IDAP_F","B_CivilianBackpack_01_Everyday_Astra_F","B_CivilianBackpack_01_Everyday_Black_F"
"rhsgref_chestrig","rhsgref_chicom","rhs_vydra_3m","rhs_vest_pistol_holster","rhs_vest_commander","rhs_6sh46","rhsgref_alice_webbing","gm_ge_bgs_vest_80_rifleman"
